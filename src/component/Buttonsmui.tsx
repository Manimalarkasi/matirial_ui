  ...
  return (
    <div>
      ...
      <Button variant='contained' color='primary' size='large'>large</Button><br />
       ...
       <b>iconbutton component</b><br />
       <IconButton aria-label='send' color='success' size='medium' onClick={()=>alert('yr msg is send')}>
       <SendIcon />
       </IconButton><br /><hr />
       <b>group button - the props are variant,orientetion,color,size,aria-lable,Disabled elevation</b>
       <Stack direction='row'>
         <ButtonGroup variant='contained' orientation='vertical' color='error' size='small' aria-label="small button group">
          <Button >right</Button>
       ...
       <Stack direction='row'>
         <ButtonGroup variant='outlined' orientation='vertical' color='secondary' size='large' aria-aria-label='alignment button group'>
          <Button >right</Button>
          <Button >center</Button>
          <Button >left</Button>
         </ButtonGroup>
       ...
       <Stack direction='row'>
         <ButtonGroup variant='text' orientation='vertical' color='info' size='medium' aria-label="medium secondary button group">
          <Button >right</Button>
          <Button >center</Button>
          <Button >left</Button>
         </ButtonGroup>
